...
const AddForm: React.FC<Props> = ({onSubmitFormToAddDish, editContact}) => {
            ...
            <form onSubmit={onSubmit} className="w-50 mx-auto">
                ...
                <div className="mb-3">
                    <button
                        ...
                        type="submit"
                    >
                        <NavLink to='/admin' className="navbar-brand">Save</NavLink>
                    </button>
                    <button
                        className="btn btn-primary"
                        type="submit"
                    >
                        <NavLink to='/admin' className="navbar-brand">Add To Dishes</NavLink>
                    </button>
                </div>
            </form>
